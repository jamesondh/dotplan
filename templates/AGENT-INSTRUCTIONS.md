...
- For medium/high-risk work, write `.planning/phases/NN-{name}/SPEC.md` before coding. Include a `Surface Area` section listing which parts of the codebase the phase touches.
